...
if (isset($data['studentName'])) {
    ...
    $insertQuery = "INSERT INTO `$classtablename`
                    (student_name, course_name, level, class, term, test1, Assignment1, Assignment2,Assignment3,Assignment4,Assignment5 ,groupdiscussion, total, date) 
                    VALUES 
                    ('$studentName', '$course','$level','$classname', '$term', '$test1', '$Assignment1', '$Assignment2','$Assignment3', '$Assignment4','$Assignment5' ,'$groupdiscussion', '$total', '$currentDate')";
