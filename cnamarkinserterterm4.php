...
if (isset($data['studentName'])) {
    ...
    $insertQuery = "INSERT INTO `$classtablename`
                    (student_name, course_name, class, term, test1, Assignment1, Assignment2,Assignment3,Assignment4,Assignment5 ,groupdiscussion, total, date) 
                    VALUES 
                    ('$studentName', '$course','$classname', '$term', '$test1', '$Assignment1', '$Assignment2','$Assignment3', '$Assignment4','$Assignment5' ,'$groupdiscussion', '$total', '$currentDate')";
