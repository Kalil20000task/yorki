...
<div class="container">
    ...
    <div class="input-group-wrapper">
        <div class="input-group">
            <label for="writingskills">Writing Skills (10)</label>
...
<script>
    ...
    function calculateTotal() {
        ...
        const grammarcomprehension = parseFloat(document.getElementById('grammarcomprehension').value) || 0;
        ...
        const total = speakingskills + readingskills + writingskills + listeningskills + grammarcomprehension + panctuality + 
        homework + participation + attendance + discipline ;
    ...
    function submitMarks() {
        ...
        const data = {
            ...
            grammarcomprehension: document.getElementById('grammarcomprehension').value,
        ...
        xhr.open("POST", "eng24markinserter.php", true);
