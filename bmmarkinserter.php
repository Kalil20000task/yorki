...
if (isset($data['studentName'])) {
    ...
    $businessplanassignment = !empty($data['businessplanassignment']) ? $data['businessplanassignment'] : 0;
    ...
    if ($result->num_rows === 0) {
        ...
        $createTableQuery = "CREATE TABLE `$classtablename` (
            ...
            businessplanassignment DECIMAL(10,1) DEFAULT 0,
    ...
    $insertQuery = "INSERT INTO `$classtablename`
                    (student_name, course_name, level, class, term, test1, test2,businessplanassignment, finalexam, total, date) 
                    VALUES 
                    ('$studentName', '$course','$level','$classname', '$term', '$test1', '$test2', '$businessplanassignment', '$finalexam', '$total', '$currentDate')";
