...
if (isset($data['studentName'])) {
    ...
    $insertQuery = "INSERT INTO `$classtablename`
                    (student_name, course_name,class, term, test1, test2,businessplanassignment, finalexam, total, date) 
                    VALUES 
                    ('$studentName', '$course','$classname', '$term', '$test1', '$test2', '$businessplanassignment', '$finalexam', '$total', '$currentDate')";
