...
if (isset($data['studentName'])) {
    ...
    $insertQuery = "INSERT INTO `$classtablename`
                    (student_name, course_name, class, term, homework1, homework2, homework3, homework4, quiz,attendance, finalexam, total, date) 
                    VALUES 
                    ('$studentName', '$course','$classname', '$term', '$homework1', '$homework2', '$homework3', '$homework4', '$quiz', '$attendance','$finalexam', '$total', '$currentDate')";
