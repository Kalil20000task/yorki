...
if (isset($data['studentName'])) {
    ...
    $insertQuery = "INSERT INTO `$classtablename`
                    (student_name, course_name, level, class, term, homework1, homework2, homework3, homework4, quiz,attendance, finalexam, total, date) 
                    VALUES 
                    ('$studentName', '$course','$level','$classname', '$term', '$homework1', '$homework2', '$homework3', '$homework4', '$quiz', '$attendance','$finalexam', '$total', '$currentDate')";
