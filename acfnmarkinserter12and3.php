...
if (isset($data['studentName'])) {
    ...
    if ($result->num_rows === 0) {
        ...
        $createTableQuery = "CREATE TABLE `$classtablename` (
            ...
            classwork1 DECIMAL(10,1) DEFAULT 0,
            classwork2 DECIMAL(10,1) DEFAULT 0,
            test1 DECIMAL(10,1) DEFAULT 0,
            test2 DECIMAL(10,1) DEFAULT 0,
            group_assignment1 DECIMAL(10,1) DEFAULT 0,
            group_assignment2 DECIMAL(10,1) DEFAULT 0,
            participation DECIMAL(10,1) DEFAULT 0,
            attendance DECIMAL(10,1) DEFAULT 0,
            final_exam DECIMAL(10,1) DEFAULT 0,
    ...
    $insertQuery = "INSERT INTO `$classtablename`
                    (student_name, course_name, class, term, classwork1, classwork2, test1, test2, group_assignment1, group_assignment2, participation, attendance, final_exam, total, date) 
                    VALUES 
                    ('$studentName', '$course','$classname', '$term', '$classwork1', '$classwork2', '$test1', '$test2', '$groupAssignment1', '$groupAssignment2', '$participation', '$attendance', '$finalExam', '$totalMarks', '$currentDate')";
