...
if (isset($data['studentName'])) {
    ...
    $classwork = !empty($data['classwork']) ? $data['classwork'] : 0;
    $homework = !empty($data['homework']) ? $data['homework'] : 0;
    $engine_practical = !empty($data['engine_practical']) ? $data['Assignmengine_practicalent1'] : 0;
    $garage = !empty($data['garage']) ? $data['garage'] : 0;
    $exam = !empty($data['exam']) ? $data['exam'] : 0;
