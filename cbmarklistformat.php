...
<div class="container">
    ...
    <div class="input-group-wrapper">
        <div class="input-group">
            <label for="homework1">Homework 1 (10)</label>
            <input type="number" id="homework1" min="0" max="10" oninput="calculateTotal()">
        </div>
        <div class="input-group">
            <label for="homework2">Homework 2 (10)</label>
            <input type="number" id="homework2" min="0" max="10" oninput="calculateTotal()">
        </div>
    ...
    <div class="input-group">
            <label for="homework3">Homework 3 (10)</label>
            <input type="number" id="homework3" min="0" max="10" oninput="calculateTotal()">
        </div>
        <div class="input-group">
            <label for="homework4">Homework 4 (10)</label>
            <input type="number" id="homework4" min="0" max="10" oninput="calculateTotal()">
        </div>
    </div>
    <div class="input-group-wrapper">
       
    <div class="input-group">
            <label for="quiz">Quiz (20)</label>
            <input type="number" id="quiz" min="0" max="20" oninput="calculateTotal()">
        </div>
        <div class="input-group">
...
<script>
    ...
    function calculateTotal() {
        ...
        const total = homework1 + homework2 + homework3 + homework4 + quiz + attendance + finalexam;
    ...
    function submitMarks() {
        ...
        xhr.open("POST", "cbmarkinserter.php", true);
