...
if (isset($data['studentName'])) {
    ...
    if ($result->num_rows === 0) {
        ...
        $createTableQuery = "CREATE TABLE `$classtablename` (
            ...
            GroupAssignment DECIMAL(10,1) DEFAULT 0,
    ...
    $insertQuery = "INSERT INTO `$classtablename`
                    (student_name, course_name, level, class, term, test1, test2, Assignment1, Assignment2, GroupAssignment, finalexam, total, date) 
                    VALUES 
                    ('$studentName', '$course','$level','$classname', '$term', '$test1', '$test2', '$Assignment1', '$Assignment2', '$GroupAssignment', '$finalexam', '$total', '$currentDate')";
